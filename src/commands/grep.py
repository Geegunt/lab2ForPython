...
def grep(pattern, path, recursive=False, case_insensitive=False):
    '''
    Ищет текст в файлах по шаблону (регулярное выражение)
     Ищет совпадение шаблона в файлах. Поддерживает рекурсивный поиск в директориях и регистронезависимый поиск.
     Args:
         pattern(str)
         path(str)
